...
namespace MiljoBoven.Models
{
    public class FakeEnvironmentCrimeRepository : IEnvironmentCrimeRepository
    {
        public IQueryable<Department> Departments => new List<Department>
        {
            ...
            new Department {DepartmentId = "D02", DepartmentName = "IT-avdelningen"},
            new Department {DepartmentId = "D03", DepartmentName = "Lek och Skoj"},
            new Department {DepartmentId = "D04", DepartmentName = "Miljöskydd"}
        }.AsQueryable<Department>(); // Vi gör Listan Departments 

        public IQueryable<Errand> Errands => new List<Errand>
        {
            new Errand
            {
                ErrandID = "2020-45-0001", Place = "Skogslunden vid Jensens gård", TypeOfCrime = "Sopor",
                ...
                InvestigatorAction =
                    "Brev har skickats till Gösta Olsson om soporna och anmälan har gjorts till polisen 2018-05-01",
                InformerName = "Ada Bengtsson", InformerPhone = "0432-5545522", StatusId = "Klar",
                DepartmentId = "Renhållning och avfall", EmployeeId = "Susanne Fred"
            },

            new Errand
            {
                ErrandID = "2020-45-0002", Place = "Småstadsjön", TypeOfCrime = "Oljeutsläpp",
            ...
            new Errand
            {
                ErrandID = "2020-45-0003", Place = "Ödehuset", TypeOfCrime = "Skrot",
            ...
            new Errand
            {
                ErrandID = "2020-45-0004", Place = "Restaurang Krögaren", TypeOfCrime = "Buller",
            ...
            new Errand
            {
                ErrandID = "2020-45-0005", Place = "Torget", TypeOfCrime = "Klotter",
                DateOfObservation = new DateTime(2020, 07, 10),
                Observation = "Samtliga skräpkorgar och bänkar är nedklottrade",
                InvestigatorInfo = "", InvestigatorAction = "", InformerName = "Peter Svensson",
                InformerPhone = "0432-5322555",
                StatusId = "Inrapporterad", DepartmentId = "Ej tillsatt", EmployeeId = "Ej tillsatt"
            }
        }.AsQueryable<Errand>();

        public IQueryable<ErrandStatus> ErrandsStatus => new List<ErrandStatus>
        {
            new ErrandStatus {StatusId = "S_A", StatusName = "Rapportering"},
